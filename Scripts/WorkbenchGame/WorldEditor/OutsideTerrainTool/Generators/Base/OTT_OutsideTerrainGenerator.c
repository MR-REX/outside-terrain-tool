...
{	
	...
	protected array<ref array<float>> GetTerrainHeightmap(int width, int height, bool useUnitScale = false)
	{
		array<ref array<float>> heightmap = m_Terrain.GetHeightmap(height, width, useUnitScale);
